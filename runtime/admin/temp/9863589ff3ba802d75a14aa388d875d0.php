<?php /*a:2:{s:46:"D:\work\08\17_3\app\admin\view\news\index.html";i:1787050436;s:42:"D:\work\08\17_3\app\admin\view\layout.html";i:1787032439;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="UTF-8">
...
function doSave(){
    ...
    ajaxPost('/admin/news/save', data, function(res){
        alert(res.msg);
...
function del(id){
    confirmDialog('确定删除该新闻吗？', function(){
        ajaxPost('/admin/news/delete', {id:id}, function(res){
...
function doFilter(){
    ...
    location.href = '/admin/news/index?status=' + st + '&keyword=' + encodeURIComponent(kw);
}
</script>

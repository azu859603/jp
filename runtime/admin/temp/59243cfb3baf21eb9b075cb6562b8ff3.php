<?php /*a:2:{s:58:"/www/wwwroot/2026/08/16/17_3/app/admin/view/bid/index.html";i:1787183887;s:55:"/www/wwwroot/2026/08/16/17_3/app/admin/view/layout.html";i:1787106485;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>出价记录 - 竞拍商城</title>
<style>
...
<div class="layout">
    ...
    <div class="main">
        <header class="topbar">
            <div class="breadcrumb">竞拍管理 / <b>出价记录</b></div>
        ...
        <div class="dialog-body">
            <div class="form-group" style="margin-bottom:12px;">
                ...
                <select class="form-control" id="addGoods" onchange="onGoodsChange()">
                    ...
                    <option value="<?php echo htmlentities((string) $g['id']); ?>" data-top="<?php echo htmlentities((string) $g['top_price']); ?>" data-raise="<?php echo htmlentities((string) $g['raise_price']); ?>"><?php echo htmlentities((string) $g['title']); ?>（ID:<?php echo htmlentities((string) $g['id']); ?>）</option>
                    <?php endforeach; ?>
                </select>
            </div>
            <div class="form-group" style="margin-bottom:12px;">
                ...
                <select class="form-control" id="addUser">
                    ...
                    <option value="<?php echo htmlentities((string) $u['id']); ?>"><?php echo !empty($u['nickname']) ? htmlentities((string) $u['nickname']) : htmlentities((string) $u['mobile']); ?>（<?php echo htmlentities((string) $u['mobile']); ?>）</option>
                    <?php endforeach; ?>
                </select>
            </div>
            <div class="form-group" style="margin-bottom:12px;">

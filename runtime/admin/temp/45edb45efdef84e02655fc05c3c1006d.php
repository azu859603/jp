<?php /*a:2:{s:47:"D:\work\08\17_3\app\admin\view\order\index.html";i:1787106305;s:42:"D:\work\08\17_3\app\admin\view\layout.html";i:1787106090;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>订单列表 - 竞拍商城</title>
<style>
...
<div class="layout">
    ...
    <div class="main">
        <header class="topbar">
            <div class="breadcrumb">订单管理 / <b>订单列表</b></div>
...
<div class="search-bar">
    <input type="text" class="form-control" id="keyword" placeholder="订单号/商品/买家手机号">
            ...
            if(!res.data || !res.data.length){
                ...
                res.data.forEach(function(o){
                    ...
                    html += '<tr>'
                        + '<td>' + o.id + '</td>'
                        + '<td>' + o.order_no + '</td>'
                        + '<td style="max-width:200px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;" title="' + o.goods_title + '">' + o.goods_title + '</td>'
                        + '<td>' + (o.buyer_name || o.buyer_mobile || o.buyer_id) + '</td>'
                        + '<td>' + (o.seller_name || o.seller_mobile || o.seller_id) + '</td>'
                        + '<td class="price">￥' + o.price + '</td>'
                        + '<td>￥' + o.commission + '</td>'
                        + '<td>' + payHtml + '</td>'
                        + '<td><span class="tag ' + st[1] + '">' + st[0] + '</span></td>'
                        + '<td>' + (o.create_time ? fmtTime(o.create_time) : '-') + '</td>'
                        + '<td><a class="btn btn-sm" href="/admin1314/order/detail?id=' + o.id + '">详情</a></td></tr>';
                });
            }

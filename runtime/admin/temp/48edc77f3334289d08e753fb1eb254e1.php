<?php /*a:2:{s:45:"D:\work\08\17_3\app\admin\view\log\index.html";i:1786976563;s:42:"D:\work\08\17_3\app\admin\view\layout.html";i:1787032439;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="UTF-8">
...
<div class="search-bar">
    <input type="text" class="form-control" id="keyword" placeholder="搜索操作内容" style="min-width:220px;">
...
function loadList(page){
    fetch('/admin/log/index?page=' + page + '&limit=15&keyword=' + encodeURIComponent(document.getElementById('keyword').value), {headers:{'X-Requested-With':'XMLHttpRequest'}})
...
function clearLog(){
    confirmDialog('确定清空所有操作日志吗？清空后不可恢复！', function(){
        ajaxPost('/admin/log/clear', {}, function(res){

<?php /*a:2:{s:58:"/www/wwwroot/2026/08/16/17_3/app/admin/view/log/index.html";i:1787106493;s:55:"/www/wwwroot/2026/08/16/17_3/app/admin/view/layout.html";i:1787106485;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>操作日志 - 竞拍商城</title>
<style>
...
<div class="layout">
    ...
    <div class="main">
        <header class="topbar">
            <div class="breadcrumb">系统设置 / <b>操作日志</b></div>
...
<div class="search-bar">
    <input type="text" class="form-control" id="keyword" placeholder="搜索操作内容">
...
<div class="card">
    <div class="table-wrap">
        <table class="table">
            <thead>
            <tr>
                <th>ID</th><th>管理员</th><th>操作内容</th><th>IP</th><th>时间</th>
            </tr>
            </thead>
...
function loadList(page){
    fetch('/admin1314/log/index?page=' + page + '&limit=15&keyword=' + encodeURIComponent(document.getElementById('keyword').value), {headers:{'X-Requested-With':'XMLHttpRequest'}})
        ...
        .then(function(res){
            ...
            if(!res.data || !res.data.length){
                ...
                res.data.forEach(function(l){
                    html += '<tr>'
                        + '<td>' + l.id + '</td>'
                        + '<td>' + (l.real_name || l.username || ('ID:' + l.admin_id)) + '</td>'
                        + '<td>' + l.action + '</td>'
                        + '<td>' + l.ip + '</td>'
...
function clearLog(){
    confirmDialog('确定清空所有操作日志吗？清空后不可恢复！', function(){
        ajaxPost('/admin1314/log/clear', {}, function(res){
            alert(res.msg); if(res.code == 1) loadList(1);
        });
    });
}

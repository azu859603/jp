<?php /*a:2:{s:48:"D:\work\08\17_3\app\admin\view\banner\index.html";i:1787032368;s:42:"D:\work\08\17_3\app\admin\view\layout.html";i:1787104250;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="UTF-8">
...
function uploadBannerImg(){
    ...
    input.onchange = function(e){
        ...
        var fd = new FormData();
        fd.append('file', file);
        fetch('/admin/banner/upload', {method:'POST', headers:{'X-Requested-With':'XMLHttpRequest'}, body:fd})
...
function doSave(){
    ...
    ajaxPost('/admin/banner/save', data, function(res){
        alert(res.msg);
...
function del(id){
    confirmDialog('确定删除该轮播图吗？', function(){
        ajaxPost('/admin/banner/delete', {id:id}, function(res){

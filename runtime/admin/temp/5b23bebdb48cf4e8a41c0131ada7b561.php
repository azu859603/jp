<?php /*a:2:{s:61:"/www/wwwroot/2026/08/16/17_3/app/admin/view/banner/index.html";i:1787106488;s:55:"/www/wwwroot/2026/08/16/17_3/app/admin/view/layout.html";i:1787106485;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>轮播管理 - 竞拍商城</title>
<style>
...
<div class="layout">
    ...
    <div class="main">
        <header class="topbar">
            <div class="breadcrumb">系统设置 / <b>轮播管理</b></div>
...
<div class="card">
    <div class="table-wrap">
        <table class="table">
            ...
            <?php else: if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$b): $mod = ($i % 2 );++$i;?>
            <tr>
                <td><?php echo htmlentities((string) $b['id']); ?></td>
                <td><img src="<?php echo htmlentities((string) $b['image']); ?>" style="width:88px;height:44px;border-radius:4px;object-fit:cover;vertical-align:middle;"></td>
                <td><?php echo !empty($b['title']) ? htmlentities((string) $b['title']) : '-'; ?></td>
                <td style="max-width:180px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;"><?php echo !empty($b['url']) ? htmlentities((string) $b['url']) : '-'; ?></td>
                <td><?php echo htmlentities((string) $b['sort']); ?></td>
                <td><?php if($b['status'] == 1): ?><span class="tag tag-green">显示</span><?php else: ?><span class="tag tag-gray">隐藏</span><?php endif; ?></td>
                <td style="white-space:nowrap;">
                    <a class="btn btn-sm" href="javascript:;" onclick="openEdit(<?php echo htmlentities((string) $b['id']); ?>)">编辑</a>
                    <a class="btn btn-sm btn-danger" href="javascript:;" onclick="del(<?php echo htmlentities((string) $b['id']); ?>)">删除</a>
                </td>
            </tr>
            <?php endforeach; endif; else: echo "" ;endif; ?>
            <?php endif; ?>
...
<script>
var editData = <?php echo json_encode($list, JSON_UNESCAPED_UNICODE); ?>;

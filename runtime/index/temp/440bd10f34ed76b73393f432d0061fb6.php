<?php /*a:2:{s:47:"D:\work\08\17_3\app\index\view\news\detail.html";i:1787050505;s:42:"D:\work\08\17_3\app\index\view\layout.html";i:1787008265;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
...
<style>
.news-detail{background:#fff;padding:16px 14px 20px;}
.news-detail h1{font-size:18px;font-weight:600;color:#333;line-height:1.5;}
.news-detail .nd-meta{font-size:12px;color:#bbb;margin-top:8px;padding-bottom:14px;border-bottom:1px solid #f5f5f5;}
.news-detail .nd-content{margin-top:14px;font-size:14px;color:#444;line-height:1.9;word-break:break-word;}
</style>
<div class="news-detail">
    <h1><?php echo htmlentities((string) $news['title']); ?></h1>
    <div class="nd-meta">发布于 <?php echo htmlentities((string) date('Y-m-d H:i',!is_numeric($news['create_time'])? strtotime($news['create_time']) : $news['create_time'])); ?></div>
    <div class="nd-content"><?php echo htmlentities((string) nl2br($news['content'])); ?></div>
</div>

<?php /*a:2:{s:47:"D:\work\08\17_3\app\index\view\user\invite.html";i:1787032434;s:42:"D:\work\08\17_3\app\index\view\layout.html";i:1787008265;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
...
<div class="invite-card">
    ...
    <div class="inv-t">我的邀请码</div>
    <div class="inv-code"><?php echo htmlentities((string) $user['invite_code']); ?></div>
    <div class="inv-tip">邀请好友注册，好友填写你的邀请码即可获得积分奖励</div>
    <button class="inv-btn" onclick="copyInvite()">复制邀请码</button>
    <div class="inv-tip">好友注册时填写此邀请码<br>可获得积分奖励，多邀多得</div>
</div>
...
function copyInvite() {
    ...
    ta.value = '<?php echo htmlentities((string) $user['invite_code']); ?>';
    document.body.appendChild(ta);
    ta.select();
    try { document.execCommand('copy'); toast('邀请码已复制'); } catch(e) { toast('<?php echo htmlentities((string) $user['invite_code']); ?>'); }

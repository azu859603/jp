...
var LANG = (metaLang ? metaLang.getAttribute('content') : '') || getCookie(COOKIE_KEY) || w.localStorage.getItem(LS_KEY) || 'zh-tw';
    ...
    var DICT = {
        ...
        '收款码已上传': ['收款碼已上傳', 'QR code uploaded'],
        '开户行：': ['開戶行：', 'Branch: '],
        '银行卡号': ['銀行卡號', 'Card Number'],
        '请输入银行卡号': ['請輸入銀行卡號', 'Enter bank card number'],
        '请输入 USDT-TRC20 钱包地址': ['請輸入 USDT-TRC20 錢包地址', 'Enter USDT-TRC20 wallet address'],
        ...
        '禁用原因：': ['禁用原因：', 'Reason: '],
        '账号已被禁用': ['賬號已被禁用', 'Account disabled'],
        ...
        '为保证信息准确，请手动输入，不支持粘贴': ['為保證信息準確，請手動輸入，不支持粘貼', 'Please type it in manually. Pasting is not allowed'],
        '请输入正确的邮箱地址': ['請輸入正確的郵箱地址', 'Please enter a valid email address'],
        '请输入账号和密码': ['請輸入賬號和密碼', 'Please enter your account and password'],

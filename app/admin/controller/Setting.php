    ...
    public function index()
    {
        if ($this->request->isPost()) {
            $fields = [
                ...
                'auto_view_enabled', 'auto_view_amount', 'auto_view_float', 'pay_account_editable', 'register_mode',
            ...
            foreach ($fields as $field) {
                ...
                if ($field === 'platform_auto_bid_enabled' || $field === 'agent_balance_adjust' || $field === 'auto_view_enabled' || $field === 'pay_account_editable') {
                    $value = (string)$value === '1' ? '1' : '0';
                }
                if ($field === 'register_mode') {
                    $value = $value === 'email' ? 'email' : 'mobile';
                }
        ...
        $defaults = [
            ...
            'auto_view_enabled' => '0', 'auto_view_amount' => '5', 'auto_view_float' => '50', 'pay_account_editable' => '0', 'register_mode' => 'mobile',

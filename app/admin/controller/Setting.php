    ...
    public function index()
    {
        if ($this->request->isPost()) {
            $fields = [
                ...
                'auto_view_enabled', 'auto_view_amount', 'auto_view_float', 'pay_account_editable',
        ...
        $defaults = [
            ...
            'auto_view_enabled' => '0', 'auto_view_amount' => '5', 'auto_view_float' => '50', 'pay_account_editable' => '0',
